    ...
    <div className="flex min-h-screen">
      ...
      <aside className="hidden md:flex flex-col h-screen w-60 fixed left-0 top-0 bg-[#001A33] py-5 z-50">
        ...
        <nav className="flex-1 space-y-0.5 px-2 overflow-y-auto">
          ...
          <Link
            to="/ciudadano/crear"
            className="sidebar-link rounded-lg px-3 py-2.5 flex items-center gap-2.5 text-sm text-slate-300 hover:text-white"
          >
          ...
          >
            ...
            <span className="ml-auto bg-orange-500/20 text-orange-300 text-[9px] font-bold px-2 py-0.5 rounded-full">
              3
            </span>
          </a>
          ...
          <a
            href="#"
            className="sidebar-link sidebar-active rounded-lg px-3 py-2.5 flex items-center gap-2.5 text-sm text-white"
          >
            <span className="material-symbols-outlined text-lg fill-icon">dashboard</span>
          ...
          >
            ...
            <span className="font-headline font-medium">Mapa</span>
          </a>
          <a
            href="#"
            className="sidebar-link rounded-lg px-3 py-2.5 flex items-center gap-2.5 text-sm text-slate-300 hover:text-white"
        ...
        <div className="px-3 mt-auto">
          <Link
            to="/login"
            className="text-slate-400 hover:text-white px-2 py-2 flex items-center gap-2 text-sm"
          >
      ...
      {/* MAIN CONTENT */}
      <main className="md:ml-60 p-4 md:p-8 flex-1">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-8">
          ...
          <div style={{ height: '350px' }}>
            <MapComponent markers={mockMarkers} height="350px" />
          </div>
        </div>
          ...
          <div className="divide-y divide-[#f5f3f3]">
            <div className="px-4 md:px-5 py-3 flex items-center justify-between hover:bg-[#f5f3f3]/50">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-red-100 flex items-center justify-center text-red-700 text-[10px] font-bold">
                  RP
                </div>
                <div>
            ...
            <div className="px-4 md:px-5 py-3 flex items-center justify-between hover:bg-[#f5f3f3]/50">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-amber-100 flex items-center justify-center text-amber-700 text-[10px] font-bold">
                  MS
                </div>
                <div>
              ...
              <span className="badge-proceso px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase">
                En Proceso
              </span>
            </div>
            <div className="px-4 md:px-5 py-3 flex items-center justify-between hover:bg-[#f5f3f3]/50">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-slate-700 text-[10px] font-bold">
                  JL
                </div>
                <div>
              ...
              <span className="badge-pendiente px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase">
                Pendiente
              </span>
            </div>
          </div>
