    ...
    <div>
      ...
      <aside className="hidden md:flex flex-col h-screen w-60 fixed left-0 top-0 bg-[#001A33] py-5 z-50">
        ...
        <nav className="flex-1 space-y-0.5 px-2 overflow-y-auto">
          ...
          <Link to="/super/auditoria" className="sidebar-link sidebar-active rounded-lg px-3 py-2.5 flex items-center gap-2.5 text-sm text-white">
            <span className="material-symbols-outlined text-lg fill-icon">policy</span>
      ...
      <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
        ...
        <div className="mobile-menu-panel">
          ...
          <nav className="space-y-1">
            ...
            <Link to="/super/auditoria" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 text-white font-headline font-medium py-2.5 px-3 rounded-lg bg-white/10 text-sm">
